...
import 'package:owwn_coding_challenge/data/services/response_objects/tokens_response.dart';
...
class AuthInterceptor extends InterceptorsWrapper {
  ...
  late DioError? _tokenRefreshDioError;
  ...
  Future<AuthTokens> _getNewTokens(RequestOptions requestOptions) async {
    try {
      ...
      return TokensResponse.fromJson(response).getEntity();
    } on DioError catch (e) {
